...
def create_structure(): 
    ...
    #region configs
    content_standard_processses = """# Its very important the sample name is exactly correct, as it is used to find filepaths in essentially every step
...
filtering_args = {
    ...
    "processed_edge_files"          :   "SRR07_edge_list_sequences.csv" #this hould be in the "Input_files" folder
                            , 
    "nUMI_sum_per_bead_thresholds"  :   [2, 10000], 
    "n_connected_cells_thresholds"  :   [2, 10000], 
...
reconstruction_args = {
    ...
    #-----------------------------
    "reconstructions_per_edgelist"      : 10,
...
subgraph_to_analyse = {
    ...
    "gating_threshold"          : "all", # None, all, dbscan, or a number that has distance gated files 
...
vizualisation_args = {
    ...
    "color_scheme"              : "cell_type",       # cell_type, vertical, horizontal, radius, knn, distortion
    "colormap"                  : "viridis",     #Any matplotlib colormap, recommend viridis or tab10
    "colours"                   : "tonsil",
...
visualization_args = {
    ...
    #endregion
    for content, str in zip([content_standard_processses, content_subgraph_modification, content_subgraph_analysis, content_base_network_analysis], ["config_standard_processses", "config_subgraph_modification", "config_subgraph_analysis", "config_base_network_analysis"]):
